...
time python ${SANPI_DIR}/source/collect_deps.py --input_dir ${DATA_DIR}/2_hit_tables --glob_expr RBdirect/\*neg\*hits.pkl.gz --output_dir ${DATA_DIR}/3_dep_info --verbose >> >(tee -i -a ${LOG_FILE}) 2>&1
