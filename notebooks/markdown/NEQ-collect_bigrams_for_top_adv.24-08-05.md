...
/share/compling/projects/sanpi/results/top_AM/NEQ/NEQ-Top8/NEQ-Top8_NEG-ADV-5000_Top10-bigrams-50.2024-08-05.csv
...
> saved as:  
> `/share/compling/projects/sanpi/results/top_AM/NEQ/NEQ-Top8/NEQ-Top8_NEG-ADV-5000_Top10-bigrams-50.2024-08-05.md`
...
```python
nb_show_table(NEG_bigrams_sample.filter(like='O', axis=0).filter(adjust_ams(FOCUS)).drop(columns=['l1', 'l2', 'adv', 'adj']).sort_values(METRIC_PRIORITY_DICT[TAG]))
```

`COM` or `POS` propensity (positive associations) of selected bigrams

|                            | `f` | `dP1` | `LRC` | `P1` |   `G2` |      `f1` | `f2` |       `N` | `exp_f` | `unexp_f` | `unexp_r` | `dP2` | `P2` | `adv_total` | `adj_total` | `odds_r_disc` |  `t` | `MI` |
|:---------------------------|----:|------:|------:|-----:|-------:|----------:|-----:|----------:|--------:|----------:|----------:|------:|-----:|------------:|------------:|--------------:|-----:|-----:|
| **POS~terribly_wrong**     | 340 |  0.31 |  1.16 | 0.81 | 169.53 |   291,735 |  422 |   583,470 |  211.00 |    129.00 |      0.38 |  0.00 | 0.00 |       2,196 |       8,526 |          0.62 | 7.00 | 0.21 |
| **COM~ever_deeper**        |  77 |  0.49 |  1.70 | 0.99 |  97.43 | 3,173,681 |   78 | 6,347,362 |   39.00 |     38.00 |      0.49 |  0.00 | 0.00 |      10,849 |       1,823 |          1.71 | 4.33 | 0.30 |
| **COM~longer_lasting**     | 151 |  0.47 |  2.32 | 0.97 | 177.73 | 3,173,681 |  155 | 6,347,362 |   77.50 |     73.50 |      0.49 |  0.00 | 0.00 |       1,803 |       1,450 |          1.53 | 5.98 | 0.29 |
| **COM~ever_higher**        | 123 |  0.49 |  2.45 | 0.99 | 160.27 | 3,173,681 |  124 | 6,347,362 |   62.00 |     61.00 |      0.50 |  0.00 | 0.00 |      10,849 |      13,093 |          1.92 | 5.50 | 0.30 |
| **COM~ever_larger**        | 113 |  0.50 |  2.56 | 1.00 | 156.65 | 3,173,681 |  113 | 6,347,362 |   56.50 |     56.50 |      0.50 |  0.00 | 0.00 |      10,849 |       7,136 |          2.36 | 5.32 | 0.30 |
| **COM~particularly_acute** | 120 |  0.50 |  2.65 | 1.00 | 166.36 | 3,173,681 |  120 | 6,347,362 |   60.00 |     60.00 |      0.50 |  0.00 | 0.00 |      76,722 |       1,097 |          2.38 | 5.48 | 0.30 |
| **COM~ever_greater**       | 169 |  0.49 |  2.94 | 0.99 | 223.41 | 3,173,681 |  170 | 6,347,362 |   85.00 |     84.00 |      0.50 |  0.00 | 0.00 |      10,849 |       6,678 |          2.05 | 6.46 | 0.30 |
| **COM~ever_closer**        | 297 |  0.49 |  3.61 | 0.99 | 390.50 | 3,173,681 |  299 | 6,347,362 |  149.50 |    147.50 |      0.50 |  0.00 | 0.00 |      10,849 |       3,488 |          2.08 | 8.56 | 0.30 |
