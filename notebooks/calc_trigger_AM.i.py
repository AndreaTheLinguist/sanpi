...
prone = sig_trig_abbr.copy().loc[sig_trig_abbr.l2.isin(prone_list), ['f2', 'l2']].drop_duplicates(
...
ix, exdf = show_prone_ex(
    sig_trig_abbr, [r'exactly\w*'] if UNIT != 'Adj' else [r'un\w+'])
exdf
# %%
