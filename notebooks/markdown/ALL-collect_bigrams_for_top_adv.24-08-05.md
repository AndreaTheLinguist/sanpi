...
| **NEGany~necessarily_representative** |    0.95 |    8.43 | 2,994.07 |   0.99 |   487 | 3,173,681 |    491 |        48,641 |        18,160 |
...
> Saved as:  
>   `/share/compling/projects/sanpi/results/top_AM/ALL/ALL-Top8/ALL-Top8_NEG-ADV-5000_Top10-bigrams-50.2024-08-05.csv`
...
> saved as:  
> `/share/compling/projects/sanpi/results/top_AM/ALL/ALL-Top8/ALL-Top8_NEG-ADV-5000_Top10-bigrams-50.2024-08-05.md`
...
```python
# pos_top_bigrams = NEG_bigrams_sample.filter(like='O', axis=0)
# nb_show_table(pos_top_bigrams, transpose=True, n_dec=3)
```
