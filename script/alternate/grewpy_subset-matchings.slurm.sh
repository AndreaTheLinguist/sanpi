...
if [[ -n "${SLURM_JOB_ID}" ]]; then
    ...
    echo "script: /share/compling/projects/sanpi/grewpy_subset.slurm.1.sh"
    echo ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . ."
...
echo "time python /share/compling/projects/sanpi/script/create_grewpy_subset.1.py -n $1 $PAT $2 > ${SLURM_JOB_NAME}.${SLURM_JOB_ID}.md"
time python /share/compling/projects/sanpi/script/create_grewpy_subset.1.py -n $1 $PAT $2 > ${SLURM_JOB_NAME}.${SLURM_JOB_ID}.md
